...
const (
	...
	CategoryService_DeleteCategoryStreamBidirectional_FullMethodName = "/pb.CategoryService/DeleteCategoryStreamBidirectional"
)
...
type CategoryServiceClient interface {
	...
	DeleteCategoryStreamBidirectional(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[DeleteCategoryRequest, DeleteCategoryResponse], error)
}
...
func (c *categoryServiceClient) DeleteCategoryStreamBidirectional(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[DeleteCategoryRequest, DeleteCategoryResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &CategoryService_ServiceDesc.Streams[2], CategoryService_DeleteCategoryStreamBidirectional_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[DeleteCategoryRequest, DeleteCategoryResponse]{ClientStream: stream}
	return x, nil
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type CategoryService_DeleteCategoryStreamBidirectionalClient = grpc.BidiStreamingClient[DeleteCategoryRequest, DeleteCategoryResponse]
...
type CategoryServiceServer interface {
	...
	DeleteCategoryStreamBidirectional(grpc.BidiStreamingServer[DeleteCategoryRequest, DeleteCategoryResponse]) error
...
func (UnimplementedCategoryServiceServer) DeleteCategoryStreamBidirectional(grpc.BidiStreamingServer[DeleteCategoryRequest, DeleteCategoryResponse]) error {
	return status.Errorf(codes.Unimplemented, "method DeleteCategoryStreamBidirectional not implemented")
}
...
func _CategoryService_DeleteCategoryStreamBidirectional_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(CategoryServiceServer).DeleteCategoryStreamBidirectional(&grpc.GenericServerStream[DeleteCategoryRequest, DeleteCategoryResponse]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type CategoryService_DeleteCategoryStreamBidirectionalServer = grpc.BidiStreamingServer[DeleteCategoryRequest, DeleteCategoryResponse]
...
var CategoryService_ServiceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		...
		{
			StreamName:    "DeleteCategoryStreamBidirectional",
			Handler:       _CategoryService_DeleteCategoryStreamBidirectional_Handler,
			ServerStreams: true,
			ClientStreams: true,
		},
	},
